...
async function E(e, r) {
    ...
    if (c != null && c.subtle) {
        ...
        const { KJUR: l, KEYUTIL: u, b64utoutf8: f } = await __turbopack_context__.r("[project]/node_modules/@kinde/jwt-validator/dist/jsrsasign-B2gZIJhY.js [app-route] (ecmascript, async loader)")(__turbopack_context__.i).then((g)=>g.j), s = JSON.parse(f(t));
...
"[project]/node_modules/@kinde/js-utils/dist/main-Cga9T8xH.js [app-route] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
const ne = (e)=>{
    ...
    if (r.codeChallenge) s.code_challenge = r.codeChallenge;
        ...
        f = u, i && i.setSessionItem(a.codeVerifier, u), s.code_challenge = h;
    }
...
const _ = {
...
}, se = async ({ urlParams: e, domain: t, clientId: r, redirectURL: n, autoRefresh: o = !1, onRefresh: i })=>{
    const s = e.get("state"), f = e.get("code");
    if (!s || !f) return console.error("Invalid state or code"), {
        success: !1,
    ...
    z && z.setItems({
        [a.accessToken]: d.access_token,
        [a.idToken]: d.id_token,
        [a.refreshToken]: d.refresh_token
    }), (c.useInsecureForRefreshToken || !v(t)) && l.setSessionItem(a.refreshToken, d.refresh_token), o && F(d.expires_in, async ()=>{
        $({
            domain: t,
            clientId: r,
            onRefresh: i
...
const Y = "_kbrte", ae = async ({ domain: e, clientId: t })=>{
    if (!e) return {
        success: !1,
...
const k = async (e = a.accessToken)=>{
...
}, M = async (e = "accessToken")=>k(e), ue = async (e, t = "accessToken")=>{
    const r = await M(t);
    return r ? {
        name: e,
        value: r[e]
    ...
    b();
    try {
        const f = await fetch(`${P(e)}/oauth2/token`, {
            method: "POST",
            ...r === w.cookie && {
                credentials: "include"
            },
    ...
    g.secure = e;
}, p = ()=>g.secure || null, ye = ()=>g.secure !== null, ve = ()=>{
    g.secure = null;
}, $e = (e)=>{
    g.insecure = e;
}, T = ()=>g.insecure || g.secure || null, Te = ()=>g.insecure !== null, xe = ()=>{
    g.insecure = null;
}, Ie = async (e)=>(console.warn("Warning: generateProfileUrl is deprecated. Please use generatePortalUrl instead."), ee({
        domain: e.domain,
...
const ee = async ({ domain: e, returnUrl: t, subNav: r })=>{
    const n = p();
    ...
    if (!f.url || typeof f.url != "string") throw new Error("Invalid URL received from API");
    try {
        return {
            url: new URL(f.url)
        };
    ...
    __esModule: !0,
    default: async ()=>(await __turbopack_context__.r("[project]/node_modules/@kinde/js-utils/dist/expoSecureStore-D7BcriRW.js [app-route] (ecmascript, async loader)")(__turbopack_context__.i)).ExpoSecureStore
};
;
}}),
"[project]/node_modules/@kinde/js-utils/dist/main-Cga9T8xH.js [app-route] (ecmascript) <export p as generatePortalUrl>": ((__turbopack_context__) => {
"use strict";

var { g: global, __dirname } = __turbopack_context__;
{
__turbopack_context__.s({
    "generatePortalUrl": (()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$kinde$2f$js$2d$utils$2f$dist$2f$main$2d$Cga9T8xH$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["p"])
});
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$kinde$2f$js$2d$utils$2f$dist$2f$main$2d$Cga9T8xH$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/@kinde/js-utils/dist/main-Cga9T8xH.js [app-route] (ecmascript)");
}}),
"[project]/node_modules/@kinde/js-utils/dist/main-Cga9T8xH.js [app-route] (ecmascript) <export N as MemoryStorage>": ((__turbopack_context__) => {
"use strict";

var { g: global, __dirname } = __turbopack_context__;
{
__turbopack_context__.s({
    "MemoryStorage": (()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$kinde$2f$js$2d$utils$2f$dist$2f$main$2d$Cga9T8xH$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["N"])
});
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$kinde$2f$js$2d$utils$2f$dist$2f$main$2d$Cga9T8xH$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/@kinde/js-utils/dist/main-Cga9T8xH.js [app-route] (ecmascript)");
}}),
"[project]/node_modules/@kinde/js-utils/dist/main-Cga9T8xH.js [app-route] (ecmascript) <export F as setActiveStorage>": ((__turbopack_context__) => {
"use strict";

var { g: global, __dirname } = __turbopack_context__;
{
__turbopack_context__.s({
    "setActiveStorage": (()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$kinde$2f$js$2d$utils$2f$dist$2f$main$2d$Cga9T8xH$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["F"])
});
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$kinde$2f$js$2d$utils$2f$dist$2f$main$2d$Cga9T8xH$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/@kinde/js-utils/dist/main-Cga9T8xH.js [app-route] (ecmascript)");
}}),
"[project]/node_modules/@kinde/js-utils/dist/main-Cga9T8xH.js [app-route] (ecmascript) <export a as StorageKeys>": ((__turbopack_context__) => {
"use strict";

var { g: global, __dirname } = __turbopack_context__;
{
__turbopack_context__.s({
    "StorageKeys": (()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$kinde$2f$js$2d$utils$2f$dist$2f$main$2d$Cga9T8xH$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["a"])
});
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$kinde$2f$js$2d$utils$2f$dist$2f$main$2d$Cga9T8xH$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/@kinde/js-utils/dist/main-Cga9T8xH.js [app-route] (ecmascript)");
}}),
"[project]/node_modules/@kinde-oss/kinde-auth-nextjs/dist/node_modules/.pnpm/@kinde_js-utils@0.18.1/node_modules/@kinde/js-utils/dist/main-BVGfrWfr.es.js [app-route] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
var d = (e, r, t)=>r in e ? g(e, r, {
        enumerable: !0,
        configurable: !0,
        writable: !0,
        value: t
    }) : e[r] = t;
var l = (e, r, t)=>d(e, typeof r != "symbol" ? r + "" : r, t);
var m = /* @__PURE__ */ ((e)=>(e.organizationDetails = "organization_details", e.organizationMembers = "organization_members", e.organizationPlanDetails = "organization_plan_details", e.organizationPaymentDetails = "organization_payment_details", e.organizationPlanSelection = "organization_plan_selection", e.profile = "profile", e))(m || {});
const $ = (e)=>e.replace(/\/$/, "");
function w(e, r) {
    return r <= 0 ? [] : e.match(new RegExp(`.{1,${r}}`, "g")) || [];
}
var h = /* @__PURE__ */ ((e)=>(e.accessToken = "accessToken", e.idToken = "idToken", e.refreshToken = "refreshToken", e.state = "state", e.nonce = "nonce", e.codeVerifier = "codeVerifier", e))(h || {});
class y {
    async setItems(r) {
        await Promise.all(Object.entries(r).map(([t, a])=>this.setSessionItem(t, a)));
    }
    async removeItems(...r) {
...
class k extends y {
   ...
   * @param {unknown} itemValue
   * @returns {void}
   */ async setSessionItem(t, a) {
        if (await this.removeSessionItem(t), typeof a == "string") {
            w(a, o.maxLength).forEach((n, s)=>{
                this.memCache[`${o.keyPrefix}${t}${s}`] = n;
            });
            return;
        }
        this.memCache[`${o.keyPrefix}${String(t)}0`] = a;
    }
    /**
   * Gets the item for the provided key from the memory cache.
   * @param {string} itemKey
   * @returns {unknown | null}
   */ async getSessionItem(t) {
        if (this.memCache[`${o.keyPrefix}${String(t)}0`] === void 0) return null;
        let a = "", n = 0, s = `${o.keyPrefix}${String(t)}${n}`;
        for(; this.memCache[s] !== void 0;)a += this.memCache[s], n++, s = `${o.keyPrefix}${String(t)}${n}`;
        return a;
    }
    /**
   * Removes the item for the provided key from the memory cache.
   ...
   * @returns {void}
   */ async removeSessionItem(t) {
        for(const a in this.memCache)a.startsWith(`${o.keyPrefix}${String(t)}`) && delete this.memCache[a];
    }
}
const o = {
    /**
   ...
   */ maxLength: 2e3
    ...
    f.secure = e;
}, p = ()=>f.secure || null, v = async ({ domain: e, returnUrl: r, subNav: t })=>{
    const a = p();
    if (!a) throw new Error("generatePortalUrl: Active storage not found");
    const n = await a.getSessionItem(h.accessToken);
    if (!n) throw new Error("generatePortalUrl: Access Token not found");
    if (!r.startsWith("http")) throw new Error("generatePortalUrl: returnUrl must be an absolute URL");
    const s = new URLSearchParams({
        sub_nav: t || m.profile,
        return_url: r
    }), i = await fetch(`${$(e)}/account_api/v1/portal_link?${s.toString()}`, {
        headers: {
            Authorization: `Bearer ${n}`
        }
    });
    if (!i.ok) throw new Error(`Failed to fetch profile URL: ${i.status} ${i.statusText}`);
    const c = await i.json();
    if (!c.url || typeof c.url != "string") throw new Error("Invalid URL received from API");
    try {
        return {
            url: new URL(c.url)
        };
    } catch (u) {
        throw console.error(u), new Error(`Invalid URL format received from API: ${c.url}`);
    }
};
;
}}),
...
//# sourceMappingURL=node_modules_79c21d0b._.js.map