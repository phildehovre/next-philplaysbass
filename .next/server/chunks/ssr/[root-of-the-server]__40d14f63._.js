...
var __TURBOPACK__imported__module__$5b$project$5d2f$services$2f$playlistService$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/services/playlistService.ts [app-ssr] (ecmascript)");
"use client";
;
;
;
...
const PlaylistModal = ({ setShow, song })=>{
    ...
    const onSubmit = async (data)=>{
        if (!user) return;
        try {
            const playlist = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$services$2f$playlistService$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["createPlaylistForUser"])({
                kindeId: user.id,
...
//# sourceMappingURL=%5Broot-of-the-server%5D__40d14f63._.js.map