...
"[project]/services/playlistService.ts [app-ssr] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
async function createPlaylistForUser({ kindeId, name, firstSongId }) {
    ...
    const playlist = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$prisma$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["prisma"].playlist.create({
        data: {
            name,
            user: {
                connect: {
...
async function addSongsToPlaylist({ playlistId, songIds }) {
    const operations = songIds.map((songId)=>__TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$prisma$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["prisma"].playlistSong.upsert({
            where: {
                playlistId_songId: {
                    playlistId,
                    songId
    ...
    return await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$prisma$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["prisma"].$transaction(operations);
}
async function getUserPlaylists(userId) {
    try {
        const playlists = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$prisma$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["prisma"].playlist.findMany({
            where: {
                userId
            },
            include: {
...
var __TURBOPACK__imported__module__$5b$project$5d2f$services$2f$playlistService$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/services/playlistService.ts [app-ssr] (ecmascript)"); // Adjust path to your function
;
;
function useCreatePlaylist() {
    return (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tanstack$2f$react$2d$query$2f$build$2f$modern$2f$useMutation$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useMutation"])({
        mutationFn: (data)=>(0, __TURBOPACK__imported__module__$5b$project$5d2f$services$2f$playlistService$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["createPlaylistForUser"])(data)
    });
}
}}),
...
const PlaylistModal = ({ setShow, song })=>{
    ...
    const { mutate: createPlaylist, isPending, error } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$hooks$2f$usePlaylist$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useCreatePlaylist"])();
    const onSubmit = (data)=>{
        if (!user) return;
        createPlaylist({
            kindeId: user.id,
...
//# sourceMappingURL=%5Broot-of-the-server%5D__e9e45e6c._.js.map