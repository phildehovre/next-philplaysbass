...
const SongDropdown = ({ playlists, setShowSongPortal, song })=>{
    ...
    const handleAddToPlaylist = async (playlist, song)=>{
        ...
        try {
            ...
            const result = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$actions$2f$data$3a$8ac88a__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$text$2f$javascript$3e$__["addSongToPlaylist"])(playlist.id, mappedSong);
            ctxAddSongToPlaylist(playlist.id, mappedSong);
...
//# sourceMappingURL=_00806d4f._.js.map