...
;
;
const PlayButton = ({ isShowing, handlePlayButtonClick })=>{
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
...
const PlayerProvider = ({ children })=>{
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "PlayerProvider.useEffect": ()=>{
            if (currentTrack) {
                (0, __TURBOPACK__imported__module__$5b$project$5d2f$services$2f$Spotify$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getSpotifyTrackIdByArtistAndTitle"])(currentTrack.song_title, currentTrack.artist.name, "TOKEN BLABLABLABLA");
            }
        }
    }["PlayerProvider.useEffect"], [
        currentTrack
...
_s(PlayerProvider, "GFVKqiMaFsYNyW1lVRkWUsgoIsw=");
_c = PlayerProvider;
var _c;
...
_s(SongCard, "eqT3d4MmKpxdB9gLgA1TQ9B97WU=");
_c = SongCard;
...
//# sourceMappingURL=_1449b9c9._.js.map