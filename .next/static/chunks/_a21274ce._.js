...
const PlaylistModal = ({ setShow, song, onClose })=>{
    ...
    const { mutate: createPlaylist, isPending, error } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$hooks$2f$usePlaylist$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCreatePlaylist"])();
    const onSubmit = async (data)=>{
        ...
        if (!track) {
            const token = JSON.parse(getCookie("token") || "{}")?.access_token;
            track = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$services$2f$Spotify$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getSpotifyTrackByArtistAndTitle"])(song.song_title, song.artist.name, token);
        }
        try {
            if (!track) return;
            const mappedSong = {
...
_s(PlaylistModal, "t4rg4xdwR3wM0aq2RP3eKW6h73s=", false, function() {
    return [
        ...
        __TURBOPACK__imported__module__$5b$project$5d2f$hooks$2f$useCookies$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"],
        __TURBOPACK__imported__module__$5b$project$5d2f$hooks$2f$usePlaylist$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCreatePlaylist"]
    ];
});
_c = PlaylistModal;
...
//# sourceMappingURL=_a21274ce._.js.map