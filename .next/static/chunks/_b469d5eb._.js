...
const PlaylistModal = ({ setShow, song, onClose })=>{
    ...
    console.log("From playlist modal:", song);
...
const MetroSidebar = ({ playlists })=>{
    ...
    const renderPlaylistSongs = (pl)=>{
        ...
        return pl.songs.map((item)=>{
            ...
            return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(PlaylistItem, {
                song: song,
                playlists: playlists
            }, song.song_id, false, {
                fileName: "[project]/components/metronome/Sidebar.tsx",
...
//# sourceMappingURL=_b469d5eb._.js.map