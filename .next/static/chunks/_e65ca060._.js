...
var __TURBOPACK__imported__module__$5b$project$5d2f$services$2f$playlistService$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/services/playlistService.ts [app-client] (ecmascript)");
;
var _s = __turbopack_context__.k.signature();
"use client";
;
...
const PlaylistModal = ({ setShow, song })=>{
    ...
    const onSubmit = async (data)=>{
        if (!user) return;
        try {
            const playlist = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$services$2f$playlistService$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["createPlaylistForUser"])({
                kindeId: user.id,
...
_s(PlaylistModal, "8rrFn9LdB/cBIolrDbs7GBTs/jg=", false, function() {
    return [
...
//# sourceMappingURL=_e65ca060._.js.map