                ...
                if (currentTrack && tokenObject?.access_token) {
                    ({
                        "PlayerProvider.useEffect": async ()=>{
                            try {
                                const result = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$services$2f$Spotify$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getSpotifyTrackByArtistAndTitle"])(currentTrack.song_title, currentTrack.artist.name, tokenObject.access_token);
                                if (result) {
...
"[project]/actions/data:ad4b29 [app-client] (ecmascript) <text/javascript>": ((__turbopack_context__) => {
"use strict";
...
"[project]/actions/data:040eef [app-client] (ecmascript) <text/javascript>": ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/next/dist/compiled/react/jsx-dev-runtime.js [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/next/dist/compiled/react/index.js [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$actions$2f$data$3a$040eef__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$text$2f$javascript$3e$__ = __turbopack_context__.i("[project]/actions/data:040eef [app-client] (ecmascript) <text/javascript>");
;
var _s = __turbopack_context__.k.signature(), _s1 = __turbopack_context__.k.signature();
"use client";
;
...
const PlaylistProvider = ({ children })=>{
    ...
    const refreshPlaylists = async ()=>{
        const fresh = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$actions$2f$data$3a$040eef__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$text$2f$javascript$3e$__["getUserPlaylistsWithSongs"])();
        setPlaylists(fresh);
    };
...
_s(PlaylistProvider, "Ktt91RBJkdaqazJcRPNt/UlbY4w=");
_c = PlaylistProvider;
const usePlaylists = ()=>{
    _s1();
...
var __TURBOPACK__imported__module__$5b$project$5d2f$services$2f$Spotify$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/services/Spotify.ts [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$hooks$2f$useCookies$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/hooks/useCookies.ts [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$actions$2f$data$3a$ad4b29__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$text$2f$javascript$3e$__ = __turbopack_context__.i("[project]/actions/data:ad4b29 [app-client] (ecmascript) <text/javascript>");
...
const SongDropdown = ({ playlists, setShowSongPortal, song })=>{
    ...
    const handleAddToPlaylist = async (playlist, song)=>{
        setIsAdding(true);
        const token = JSON.parse(getCookie("token") || "{}")?.access_token;
        const res = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$services$2f$Spotify$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getSpotifyTrackByArtistAndTitle"])(song.song_title, song.artist.name, token);
        if (!res) return;
        ...
        try {
            ...
            const result = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$actions$2f$data$3a$ad4b29__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$text$2f$javascript$3e$__["addSongToPlaylist"])(playlist.id, mapped);
            if (!result) {
...
_s(SongDropdown, "LHw9jmOR1acdtQAzve4/b2zaH+c=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$hooks$2f$useCookies$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"],
...
var _c;
__turbopack_context__.k.register(_c, "SongDropdown");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(module, globalThis.$RefreshHelpers$);
}
}}),
"[project]/actions/data:ad52a1 [app-client] (ecmascript) <text/javascript>": ((__turbopack_context__) => {
"use strict";
...
"[project]/actions/playlistActions.ts [app-client] (ecmascript) <exports>": ((__turbopack_context__) => {
"use strict";

var { g: global, __dirname } = __turbopack_context__;
{
__turbopack_context__.s({
    "addSongToPlaylist": (()=>__TURBOPACK__imported__module__$5b$project$5d2f$actions$2f$data$3a$ad4b29__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$text$2f$javascript$3e$__["addSongToPlaylist"]),
    "findOrCreateSong": (()=>__TURBOPACK__imported__module__$5b$project$5d2f$actions$2f$data$3a$b6aa15__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$text$2f$javascript$3e$__["findOrCreateSong"]),
    "getUserPlaylists": (()=>__TURBOPACK__imported__module__$5b$project$5d2f$actions$2f$data$3a$ad52a1__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$text$2f$javascript$3e$__["getUserPlaylists"]),
    "getUserPlaylistsWithSongs": (()=>__TURBOPACK__imported__module__$5b$project$5d2f$actions$2f$data$3a$040eef__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$text$2f$javascript$3e$__["getUserPlaylistsWithSongs"])
});
var __TURBOPACK__imported__module__$5b$project$5d2f$actions$2f$data$3a$ad52a1__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$text$2f$javascript$3e$__ = __turbopack_context__.i("[project]/actions/data:ad52a1 [app-client] (ecmascript) <text/javascript>");
var __TURBOPACK__imported__module__$5b$project$5d2f$actions$2f$data$3a$ad4b29__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$text$2f$javascript$3e$__ = __turbopack_context__.i("[project]/actions/data:ad4b29 [app-client] (ecmascript) <text/javascript>");
var __TURBOPACK__imported__module__$5b$project$5d2f$actions$2f$data$3a$b6aa15__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$text$2f$javascript$3e$__ = __turbopack_context__.i("[project]/actions/data:b6aa15 [app-client] (ecmascript) <text/javascript>");
var __TURBOPACK__imported__module__$5b$project$5d2f$actions$2f$data$3a$040eef__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$text$2f$javascript$3e$__ = __turbopack_context__.i("[project]/actions/data:040eef [app-client] (ecmascript) <text/javascript>");
var __TURBOPACK__imported__module__$5b$project$5d2f$actions$2f$playlistActions$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__ = __turbopack_context__.i("[project]/actions/playlistActions.ts [app-client] (ecmascript) <locals>");
}}),
...
var __TURBOPACK__imported__module__$5b$project$5d2f$actions$2f$playlistActions$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$exports$3e$__ = __turbopack_context__.i("[project]/actions/playlistActions.ts [app-client] (ecmascript) <exports>");
;
var _s = __turbopack_context__.k.signature();
"use client";
;
...
const PlaylistModal = ({ setShow, song, onClose })=>{
    ...
    const onSubmit = async (data)=>{
        await (0, __TURBOPACK__imported__module__$5b$project$5d2f$actions$2f$playlistActions$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$exports$3e$__["createPlaylist"])(data.playlistName, song?.song_id).catch((err)=>{
            throw new Error(err);
        }).then(()=>{
            reset();
            onClose();
...
_s(SongCard, "59/9u8A62Xyo4uPXyDdwpJqZlQk=");
_c = SongCard;
...
_s(MetroSidebar, "drbi1c6dnAmS458UXFsLP9yZ6b0=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$context$2f$playlistContext$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["usePlaylists"]
    ];
});
...
//# sourceMappingURL=_fb87a685._.js.map