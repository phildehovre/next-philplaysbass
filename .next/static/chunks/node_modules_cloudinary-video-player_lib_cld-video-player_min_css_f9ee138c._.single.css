/* [project]/node_modules/cloudinary-video-player/lib/cld-video-player.min.css [app-client] (css) */
.vjs-svg-icon {
  fill: currentColor;
...
.cld-video-player .vjs-control:before, .cld-video-player .vjs-icon-placeholder:before, .cld-video-player .vjs-time-divider, .cld-video-player .vjs-duration, .cld-video-player .vjs-playback-rate-value, .cld-video-player .vjs-cloudinary-button:focus {
  opacity: .8;
}

.cld-video-player .vjs-control:hover:before, .cld-video-player .vjs-icon-placeholder:hover:before, .cld-video-player .vjs-time-divider:hover, .cld-video-player .vjs-duration:hover, .cld-video-player .vjs-playback-rate:hover .vjs-playback-rate-value {
  opacity: 1;
  text-shadow: none;
}
...
.cld-video-player.vjs-controls-enabled:before {
  content: "";
  pointer-events: none;
...
.cld-video-player.vjs-has-started:before, .cld-video-player.vjs-audio-only-mode:before {
  transition: opacity .1s;
  display: flex;
}
...
.cld-video-player .vjs-control-bar .vjs-play-progress:before, .cld-video-player .vjs-control-bar .vjs-play-progress .vjs-time-tooltip {
  display: none;
}
...
.vjs-controls-disabled .vjs-title-bar, .vjs-using-native-controls .vjs-title-bar, .vjs-error .vjs-title-bar, .vjs-ad-playing .vjs-title-bar {
  display: none !important;
}
...
.cld-video-player-floater {
  transition: bottom .5s ease-out, right .5s ease-out, left .5s ease-out;
  position: static;
}
...
.cld-video-player-floater.cld-video-player-floating .vjs-time-control, .cld-video-player-floater.cld-video-player-floating .vjs-upcoming-video-title-display, .cld-video-player-floater.cld-video-player-floating .vjs-recommendations-overlay {
  display: none;
}
...
.cld-video-player div.vjs-text-track-display.cld-styled-text-tracks-theme-3d div.vjs-text-track-cue > div, .cld-video-player:has(.cld-styled-text-tracks-theme-3d) ::cue {
  text-shadow: .03em .03em #ff438e, .06em .06em #ff1070, .09em .09em #dc0058, .12em .12em #a90044;
  color: #fff !important;
}
...
.ima-controls-div {
  opacity: 1;
  background: -o-linear-gradient(#07141eb3 0%, #07141e00 100%);
  background: -ms-linear-gradient(bottom, #07141eb3 0%, #07141e00 100%);
  height: 1.4em;
  filter: progid:DXImageTransform. Microsoft. gradient(startColorstr= "#0007141E", endColorstr= "#07141E", GradientType= 0);
  background: -moz-linear-gradient(#07141eb3 0%, #07141e00 100%);
  background: -webkit-gradient(linear, left bottom, left top, from(#07141eb3), to(#07141e00));
  background: -webkit-linear-gradient(#07141eb3 0%, #07141e00 100%);
  background: -o-linear-gradient(#07141eb3 0%, #07141e00 100%);
  background: linear-gradient(to top, #07141eb3 0%, #07141e00 100%);
  display: none;
  position: absolute;
  bottom: 0;
  overflow: hidden;
...
@media only screen and (width <= 768px) {
  .cld-plw-layout.cld-plw-vertical, .cld-plw-layout.cld-plw-horizontal, .cld-plw-layout.cld-plw-vertical .cld-plw-panel, .cld-plw-layout.cld-plw-horizontal .cld-plw-panel {
    flex-direction: column;
  }
  ...
  .cld-plw-layout.cld-plw-vertical .cld-plw-panel-item .cld-plw-item-title-next, .cld-plw-layout.cld-plw-horizontal .cld-plw-panel-item .cld-plw-item-title-next, .cld-plw-layout.cld-plw-vertical .cld-plw-panel-item .cld-plw-item-title-curr, .cld-plw-layout.cld-plw-horizontal .cld-plw-panel-item .cld-plw-item-title-curr {
    display: block;
  }
...
.cld-video-player .interaction-areas-container .vp-ia-item {
  justify-content: center;
  align-items: center;
  transition: top linear, left linear, width linear, height linear;
  display: inline-flex;
}
...
.cld-video-player .interaction-areas-container .vp-ia-item.theme-pulsing .vp-ia-marker-shadow {
  opacity: 0;
  border: 2px solid;
  -webkit-animation: 1.3s ease-out infinite pulsing-animation;
}
...
.cld-spbl-post-play .cld-spbl-item {
  ...
  overflow: hidden;
  transform: none;
  box-shadow: 0 4px 6px 1.2px #0000003d, 0 6px 8px 4px #0000003d;
}
...
.shoppable-products-overlay .vjs-title-bar, .shoppable-products-overlay .vjs-big-play-button {
  display: none !important;
}
...
.cld-spbl-product-hotspot:after {
  ...
  height: 8px;
  display: block;
  box-shadow: 0 0 0 4px #0078ff, 0 0 0 8px #0078ff3d;
}
...
/*# sourceMappingURL=node_modules_cloudinary-video-player_lib_cld-video-player_min_css_f9ee138c._.single.css.map*/