...
const GameSelection = (props: any) => {
	return (
		<div className="h-[20em] w-full flex flex-col justify-end items-center text-white mt-[60px] mb-[60px]">
			<Link href="/dashboard" className="flex">
				<ChevronsLeft color="gray" />
				Dashboard
			</Link>
			<ul className="tabs flex gap-1 w-full flex-col justify-evenly text-2xl ">
				<li className="tab ">
